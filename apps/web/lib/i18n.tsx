...
const dictionaries = {
  nl: {
    ...
    nav: {
      ...
      manageCommittees: 'Commissies beheren',
    ...
    polls: {
      title: 'Peilingen',
      description: 'Breng je stem uit op actuele verenigingsvragen.',
      loading: 'Peilingen laden...',
      loadError: 'Peilingen konden niet worden geladen.',
      retry: 'Opnieuw proberen',
      empty: 'Er zijn geen open of beantwoorde peilingen.',
      openUntil: 'Stemmen kan tot',
      closedAt: 'Gesloten op',
      saved: 'Je stem is opgeslagen.',
      submitVote: 'Stem indienen',
      updateVote: 'Stem bijwerken',
      personalSelection:
        'Dit zijn jouw gekozen antwoorden. Resultaten zijn alleen zichtbaar voor beheerders.',
      status: {
        draft: 'Concept',
        scheduled: 'Gepland',
        open: 'Open',
      ...
      admin: {
        title: 'Peilingen beheren',
        description:
          'Maak peilingen, plan de stemperiode en bekijk resultaten.',
        memberPage: 'Naar stempagina',
        forbidden: 'Alleen beheerders kunnen peilingen beheren.',
        loading: 'Peilingen laden...',
        polls: 'Alle peilingen',
        pollsDescription: 'Concepten, geplande, open en gesloten peilingen.',
        noPolls: 'Er zijn nog geen peilingen.',
        newPoll: 'Nieuwe peiling',
        draftDescription: 'Sla eerst een concept op en publiceer het daarna.',
        createDraft: 'Concept maken',
        question: 'Vraag',
        choiceMode: 'Keuzetype',
        singleChoice: 'Eén antwoord',
        multipleChoice: 'Meerdere antwoorden',
        opensAt: 'Opent op',
        closesAt: 'Sluit op',
        options: 'Antwoorden',
        option: 'Antwoord',
        addOption: 'Antwoord toevoegen',
        removeOption: 'Antwoord verwijderen',
        invalid: 'Vul een geldige vraag, antwoorden en stemperiode in.',
        duplicateOptions: 'Antwoorden moeten uniek zijn.',
        back: 'Terug naar peilingen',
        notFound: 'Peiling niet gevonden.',
        publish: 'Publiceren',
        archive: 'Archiveren',
        archiveConfirm: 'Deze peiling archiveren en verbergen voor leden?',
        deleteDraft: 'Concept verwijderen',
        deleteConfirm: 'Dit concept definitief verwijderen?',
        editPoll: 'Peiling bewerken',
        editDescription: 'Pas de inhoud en planning aan.',
        ballotFieldsLocked:
          'Na de eerste stem zijn alleen verlengingen van de sluitingstijd toegestaan.',
        ...
        voters: 'Stemmers',
        votersDescription:
          'Individuele keuzes zijn alleen voor beheerders zichtbaar.',
        member: 'Lid',
        selection: 'Keuze',
        noVoters: 'Er zijn nog geen stemmen uitgebracht.',
      },
    },
    profile: {
      account: 'Account',
    ...
    teams: {
      ...
      admin: {
        ...
        removeMemberDescription:
          'Dit lid wordt direct uit de selectie verwijderd.',
    ...
    committees: {
      ...
      title: 'Commissies',
      admin: {
        title: 'Commissies beheren',
        description: 'Maak commissies aan en beheer leden per seizoen.',
        forbidden: 'Geen toegang',
        forbiddenDescription: 'Alleen beheerders kunnen commissies wijzigen.',
        newCommittee: 'Nieuwe commissie',
        createCommittee: 'Commissie aanmaken',
        createDescription:
          'Vul de commissiegegevens in. De leden voeg je daarna toe.',
        activeCommittees: 'Actieve commissies',
        archivedCommittees: 'Gearchiveerde commissies',
        noActiveCommittees: 'Geen actieve commissies gevonden.',
        noArchivedCommittees: 'Geen gearchiveerde commissies gevonden.',
        name: 'Naam',
        imageUrl: 'URL bannerafbeelding',
        optional: 'Optioneel',
        creating: 'Aanmaken...',
        saving: 'Opslaan...',
        save: 'Wijzigingen opslaan',
        editCommittee: 'Commissiegegevens',
        archive: 'Archiveren',
        restore: 'Herstellen',
        archivedNotice:
          'Deze commissie is gearchiveerd. Herstel haar om leden toe te voegen.',
        roster: 'Commissieleden',
        seasonStartYear: 'Startjaar seizoen',
        addMember: 'Lid toevoegen',
        addMemberDescription:
          'Zoek een lid, kies een rol en bevestig de startdatum.',
        ...
        removeMember: 'Lid verwijderen',
        removeMemberDescription:
          'Dit lid wordt direct uit de commissie verwijderd.',
        removing: 'Verwijderen...',
        remove: 'Verwijderen',
        noMembers: 'Geen actieve commissieleden.',
        updated: 'Commissie bijgewerkt.',
        archived: 'Commissie gearchiveerd.',
        restored: 'Commissie hersteld.',
        memberAdded: 'Lid toegevoegd.',
        memberRemoved: 'Lid verwijderd.',
        loadError: 'Commissiebeheer kon niet worden geladen.',
        back: 'Terug naar commissiebeheer',
      },
    },
    documents: {
  ...
  en: {
    ...
    polls: {
      title: 'Polls',
      description: 'Cast your vote on current association questions.',
      loading: 'Loading polls...',
      loadError: 'Polls could not be loaded.',
      retry: 'Try again',
      empty: 'There are no open or answered polls.',
      openUntil: 'Voting closes at',
      closedAt: 'Closed at',
      saved: 'Your vote has been saved.',
      submitVote: 'Submit vote',
      updateVote: 'Update vote',
      personalSelection:
        'These are your selected answers. Results are visible to administrators only.',
      status: {
        draft: 'Draft',
        scheduled: 'Scheduled',
        open: 'Open',
      ...
      admin: {
        ...
        description: 'Create polls, schedule voting, and inspect results.',
        memberPage: 'Open voting page',
        forbidden: 'Only administrators can manage polls.',
        loading: 'Loading polls...',
        polls: 'All polls',
        pollsDescription: 'Draft, scheduled, open, and closed polls.',
        noPolls: 'No polls have been created yet.',
        newPoll: 'New poll',
        draftDescription: 'Save a draft first, then publish it.',
        createDraft: 'Create draft',
        question: 'Question',
        choiceMode: 'Choice type',
        singleChoice: 'One answer',
        ...
        invalid: 'Enter a valid question, answers, and voting window.',
        duplicateOptions: 'Answers must be unique.',
        back: 'Back to polls',
        notFound: 'Poll not found.',
        publish: 'Publish',
        archive: 'Archive',
        archiveConfirm: 'Archive this poll and hide it from members?',
        deleteDraft: 'Delete draft',
        deleteConfirm: 'Permanently delete this draft?',
        editPoll: 'Edit poll',
        editDescription: 'Update the content and schedule.',
        ballotFieldsLocked:
          'After the first vote, only an extension of the closing time is allowed.',
        save: 'Save changes',
        results: 'Results',
        ballot: 'vote',
        ballots: 'votes',
        voters: 'Voters',
        votersDescription:
          'Individual choices are visible to administrators only.',
        member: 'Member',
        selection: 'Selection',
        noVoters: 'No votes have been submitted yet.',
      },
    },
    profile: {
      account: 'Account',
    ...
    teams: {
      ...
      admin: {
        ...
        removeMemberDescription:
          'This member is removed from the roster immediately.',
        removing: 'Removing...',
        remove: 'Remove',
    ...
    committees: {
      ...
      admin: {
        ...
        description: 'Create committees and manage members by season.',
        forbidden: 'Access denied',
        forbiddenDescription: 'Only administrators can change committees.',
        newCommittee: 'New committee',
        createCommittee: 'Create committee',
        createDescription:
          'Enter the committee details. Add the members afterwards.',
        activeCommittees: 'Active committees',
        archivedCommittees: 'Archived committees',
        noActiveCommittees: 'No active committees found.',
        noArchivedCommittees: 'No archived committees found.',
        name: 'Name',
        ...
        saving: 'Saving...',
        save: 'Save changes',
        editCommittee: 'Committee details',
        archive: 'Archive',
        restore: 'Restore',
        archivedNotice:
          'This committee is archived. Restore it before adding members.',
        ...
        removeMember: 'Remove member',
        removeMemberDescription:
          'This member is removed from the committee immediately.',
        removing: 'Removing...',
        remove: 'Remove',
        noMembers: 'No active committee members.',
        updated: 'Committee updated.',
        archived: 'Committee archived.',
        restored: 'Committee restored.',
        memberAdded: 'Member added.',
        memberRemoved: 'Member removed.',
        loadError: 'Committee management could not be loaded.',
        back: 'Back to committee management',
      },
    },
    documents: {
