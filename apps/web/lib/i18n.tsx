...
const dictionaries = {
  nl: {
    ...
    polls: {
      ...
      personalSelection: 'Dit zijn jouw gekozen antwoorden. Resultaten zijn alleen zichtbaar voor beheerders.',
      status: {
        draft: 'Concept',
        scheduled: 'Gepland',
        open: 'Open',
      ...
      admin: {
        ...
        description: 'Maak peilingen, plan de stemperiode en bekijk resultaten.',
        ...
        ballotFieldsLocked: 'Na de eerste stem zijn alleen verlengingen van de sluitingstijd toegestaan.',
        save: 'Wijzigingen opslaan',
        results: 'Resultaten',
        ballot: 'stem',
        ballots: 'stemmen',
        voters: 'Stemmers',
        votersDescription: 'Individuele keuzes zijn alleen voor beheerders zichtbaar.',
        member: 'Lid',
        selection: 'Keuze',
  ...
  en: {
    ...
    polls: {
      ...
      personalSelection: 'These are your selected answers. Results are visible to administrators only.',
      status: {
        draft: 'Draft',
        scheduled: 'Scheduled',
        open: 'Open',
      ...
      admin: {
        ...
        ballotFieldsLocked: 'After the first vote, only an extension of the closing time is allowed.',
        save: 'Save changes',
        results: 'Results',
        ballot: 'vote',
        ballots: 'votes',
        voters: 'Voters',
        votersDescription: 'Individual choices are visible to administrators only.',
        member: 'Member',
        selection: 'Selection',
